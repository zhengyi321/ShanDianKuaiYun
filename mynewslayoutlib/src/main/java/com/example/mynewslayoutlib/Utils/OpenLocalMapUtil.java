...
/**
 * http://blog.csdn.net/u011102153/article/details/52870078
...
public class OpenLocalMapUtil {
     ...
     * @return
     */
    public  String getBaiduMapUri(String originLat, String originLon, String originName, String desLat, String desLon, String destination, String region, String src){
     ...
     * 获取打开高德地图应用uri
     */
    public  String getGdMapUri(String appName, String slat, String slon, String sname, String dlat, String dlon, String dname){
     ...
     * @return
     */
    public  String getWebBaiduMapUri(String originLat, String originLon, String originName, String desLat, String desLon, String destination, String region, String appName) {
