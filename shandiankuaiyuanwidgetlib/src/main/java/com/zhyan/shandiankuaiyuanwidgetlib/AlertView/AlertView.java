...
public class AlertView {
    ...
    protected void initViews(){
        ...
        rootView = (ViewGroup) layoutInflater.inflate(R.layout.dialog_alertview, decorView, false);
    ...
    protected void initListView(){
        ...
        if(cancel != null && style == Style.Alert){
            View itemView = LayoutInflater.from(context).inflate(R.layout.dialog_item_alertbutton, null);
