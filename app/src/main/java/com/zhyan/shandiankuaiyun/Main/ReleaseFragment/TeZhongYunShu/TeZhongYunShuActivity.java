...
public class TeZhongYunShuActivity extends BaseActivity {
    ...
    @BindView(R.id.tv_main_release_tezhongyunshu_selected_num)
    TextView tvMainReleaseTeZhongYunShuSelectedNum;

    @BindView(R.id.ib_main_release_tezhongyunshu_pic_pick)
    ImageButton ibMainReleaseTeZhongYunShuPicPick;
    @OnClick(R.id.ib_main_release_tezhongyunshu_pic_pick)
    public void ibMainReleaseTeZhongYunShuPicPickOnclick(){
    ...
    @BindView(R.id.tv_main_release_tezhongyunshu_content_begin)
    TextView tvMainReleaseTeZhongYunShuContentBegin;
    @BindView(R.id.lly_main_release_tezhongyunshu_content_begin)
    LinearLayout llyMainReleaseTeZhongYunShuContentBegin;
    @OnClick(R.id.lly_main_release_tezhongyunshu_content_begin)
    public void llyMainReleaseTeZhongYunShuContentBeginOnclick(){
        isBegin = true;
        Intent intent = new Intent(TeZhongYunShuActivity.this, CityChangeActivity.class);
        startActivityForResult(intent,CITY_CHANGE_SELECTED);
    }
    @BindView(R.id.tv_main_release_tezhongyunshu_content_reach)
    TextView tvMainReleaseTeZhongYunShuContentReach;
    @BindView(R.id.lly_main_release_tezhongyunshu_content_reach)
    LinearLayout llyMainReleaseTeZhongYunShuContentReach;
    @OnClick(R.id.lly_main_release_tezhongyunshu_content_reach)
    public void llyMainReleaseTeZhongYunShuContentReachOnclick(){
        isBegin = false;
        Intent intent = new Intent(TeZhongYunShuActivity.this, CityChangeActivity.class);
        startActivityForResult(intent,CITY_CHANGE_SELECTED);
    }

    @BindView(R.id.et_main_release_tezhongyunshu_content_title)
    EditText etMainReleaseTeZhongYunShuContentTitle;
    ...
    @BindView(R.id.et_main_release_tezhongyunshu_content_tel)
    EditText etMainReleaseTeZhongYunShuContentTel;
    @BindView(R.id.et_main_release_tezhongyunshu_content_lxr)
    EditText etMainReleaseTeZhongYunShuContentLXR;
    @BindView(R.id.et_main_release_tezhongyunshu_content_addr)
    EditText etMainReleaseTeZhongYunShuContentAddr;
    @BindView(R.id.tv_main_release_tezhongyunshu_content_desc)
    TextView tvMainReleaseTeZhongYunShuContentDesc;
    @BindView(R.id.lly_main_release_tezhongyunshu_content_desc)
    LinearLayout llyMainReleaseTeZhongYunShuContentDesc;
    @OnClick(R.id.lly_main_release_tezhongyunshu_content_desc)
    public void llyMainReleaseTeZhongYunShuContentDescOnclick(){
        Intent intent = new Intent(this, MiaoShuActivity.class);
        startActivityForResult(intent,OTHER_DESC);
    }
    @BindView(R.id.bt_main_release_tezhongyunshu_content_submit)
    Button btMainReleaseTeZhongYunShuContentSubmit;
    @OnClick(R.id.bt_main_release_tezhongyunshu_content_submit)
    public void btMainReleaseTeZhongYunShuContentSubmitOnclick(){
    ...
    private TeZhongYunShuController teZhongYunShuController;
    @Override
    protected void setContentView() {
        setContentView(R.layout.activity_main_release_tezhongyunshu_lly);
    }
    ...
    private void initController(){
        teZhongYunShuController = new TeZhongYunShuController(this);
    }
    ...
    private void submitReleaseDataToNet(){
        ...
        mainReleaseNetWork.releaseCarSourceToNet(getParam(), new Observer<CarSourceBean>() {
            ...
            public void onError(Throwable e) {
                /*Toast.makeText(TeZhongYunShuReleaseActivity.this,"this is Throwable:"+e,Toast.LENGTH_LONG).show();*/
                System.out.print("\nthis is Throwable:"+e);
                System.out.print("\nthis is Throwable:"+e);
                System.out.print("\nthis is Throwable:"+e);
                System.out.print("\nthis is Throwable:"+e);
            ...
            public void onNext(CarSourceBean carSourceBean) {
                Toast.makeText(TeZhongYunShuActivity.this,""+carSourceBean.getMsg().toString(),Toast.LENGTH_LONG).show();
            }
        });
    ...
    /*    initImgs();*/
        ...
        String address_set = tvMainReleaseTeZhongYunShuContentBegin.getText().toString().trim();
        /*String set_aid = "1";*/
        if((address_set == null)||(address_set.isEmpty())){
            Toast.makeText(this,"请输入出发地",Toast.LENGTH_LONG).show();
            return paramMap;
        }
        String address_out = tvMainReleaseTeZhongYunShuContentReach.getText().toString().trim();
        /*String set_cid = "2";*/
        if((address_out == null)||(address_out.isEmpty())){
            Toast.makeText(this,"请输入到达地",Toast.LENGTH_LONG).show();
            return paramMap;
        }
        String car_title = etMainReleaseTeZhongYunShuContentTel.getText().toString().trim();
        /*String car_title = "4";*/
        if(car_title == null){
            Toast.makeText(this,"请输入标题",Toast.LENGTH_LONG).show();
            car_title ="";
        }
        String car_type = tvMainReleaseTeZhongYunShuContentCarType.getText().toString().trim();
        /*String car_type = "5";*/
        if(car_type == null){
            car_type ="";
        }
        String car_lange = tvMainReleaseTeZhongYunShuContentCarLength.getText().toString().trim();
        /*String car_lange ="1";*/
        if(car_lange == null){
            car_lange ="";
        }

        String iphone = etMainReleaseTeZhongYunShuContentTel.getText().toString().trim();
        /*String iphone = "3";*/
        ...
        String people = etMainReleaseTeZhongYunShuContentLXR.getText().toString().trim();
        /*String people = "3";*/
        ...
        String address = etMainReleaseTeZhongYunShuContentAddr.getText().toString().trim();
        /*String address = "3";*/
       /* if((address == null)||(address.isEmpty())){
        ...
        String content = tvMainReleaseTeZhongYunShuContentDesc.getText().toString().trim();
    ...
    public void initImgs(){
        ...
        if (file.exists()) {
            ...
            //将图片显示到ImageView中
            ibMainReleaseTeZhongYunShuPicPick.setImageBitmap(bm);
...
/*        Toast.makeText(TeZhongYunShuReleaseActivity.this,"requestCode:"+requestCode,Toast.LENGTH_LONG).show();
        Toast.makeText(TeZhongYunShuReleaseActivity.this,"resultCode:"+resultCode,Toast.LENGTH_LONG).show();
        Toast.makeText(TeZhongYunShuReleaseActivity.this,"data:"+resultCode,Toast.LENGTH_LONG).show();*/
        ...
        switch (resultCode) {
            case ACTIVITY_REQUEST_SELECT_PHOTO:
               ...
               /* Log.i("mImageListSize",mImageList.get(0)+"");
                ...
                if(mImageList.size()>0) {
                    ...
                    tvMainReleaseTeZhongYunShuSelectedNum.setText("已选择"+mImageList.size()+"张照片");

                    Log.i("\nthis is mImageList:",""+mImageList.size());

                }else{
                    tvMainReleaseTeZhongYunShuSelectedNum.setText("");

                    ibMainReleaseTeZhongYunShuPicPick.setImageResource(R.mipmap.paizhao);
                }
            ...
            case CITY_CHANGE_SELECTED:
              ...
              /*  Toast.makeText(TeZhongYunShuReleaseActivity.this,"city:"+city,Toast.LENGTH_LONG).show();*/
                if(city != null){
                    if(isBegin) {
                        aid = id1;
                        cid = id2;
                        tid = id3;
                        tvMainReleaseTeZhongYunShuContentBegin.setText(city);
                    }else {
                        aid1 = id1;
                        cid1 = id2;
                        tid1 = id3;
                        tvMainReleaseTeZhongYunShuContentReach.setText(city);
                    }
                }
            ...
            case OTHER_DESC:
                ...
                if(desc != null){
                    tvMainReleaseTeZhongYunShuContentDesc.setText(desc);
                }
                break;
