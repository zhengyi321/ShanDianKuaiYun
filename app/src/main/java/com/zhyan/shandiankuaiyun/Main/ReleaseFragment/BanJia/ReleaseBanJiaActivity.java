package com.zhyan.shandiankuaiyun.Main.ReleaseFragment.BanJia;
...
import com.zhyan.shandiankuaiyun.Main.ReleaseFragment.BanJia.CarType.CarTypeActivity;
import com.zhyan.shandiankuaiyun.Main.ReleaseFragment.HuiTouChe.HuiTouCheActivity;
...
public class ReleaseBanJiaActivity extends BaseActivity {
    ...
    @BindView(R.id.tv_main_release_banjia_selected_num)
    TextView tvMainReleaseBanJiaSelectedNum;

    @BindView(R.id.ib_main_release_banjia_pic_pick)
    ImageButton ibMainReleaseBanJiaPicPick;
    @OnClick(R.id.ib_main_release_banjia_pic_pick)
    public void ibMainReleaseBanJiaPicPickOnclick(){
    ...
    @BindView(R.id.tv_main_release_banjia_content_begin)
    TextView tvMainReleaseBanJiaContentBegin;
    @BindView(R.id.lly_main_release_banjia_content_begin)
    LinearLayout llyMainReleaseBanJiaContentBegin;
    @OnClick(R.id.lly_main_release_banjia_content_begin)
    public void llyMainReleaseBanJiaContentBeginOnclick(){
        isBegin = true;
        Intent intent = new Intent(ReleaseBanJiaActivity.this, CityChangeActivity.class);
        startActivityForResult(intent,CITY_CHANGE_SELECTED);
    }
    @BindView(R.id.tv_main_release_banjia_content_reach)
    TextView tvMainReleaseBanJiaContentReach;
    @BindView(R.id.lly_main_release_banjia_content_reach)
    LinearLayout llyMainReleaseBanJiaContentReach;
    @OnClick(R.id.lly_main_release_banjia_content_reach)
    public void llyMainReleaseBanJiaContentReachOnclick(){
        isBegin = false;
        Intent intent = new Intent(ReleaseBanJiaActivity.this, CityChangeActivity.class);
        startActivityForResult(intent,CITY_CHANGE_SELECTED);
    }

    @BindView(R.id.et_main_release_banjia_content_title)
    EditText etMainReleaseBanJiaContentTitle;
    ...
    @BindView(R.id.et_main_release_banjia_content_tel)
    EditText etMainReleaseBanJiaContentTel;
    @BindView(R.id.et_main_release_banjia_content_lxr)
    EditText etMainReleaseBanJiaContentLXR;
    @BindView(R.id.et_main_release_banjia_content_addr)
    EditText etMainReleaseBanJiaContentAddr;
    @BindView(R.id.tv_main_release_banjia_content_desc)
    TextView tvMainReleaseBanJiaContentDesc;
    @BindView(R.id.lly_main_release_banjia_content_desc)
    LinearLayout llyMainReleaseBanJiaContentDesc;
    @OnClick(R.id.lly_main_release_banjia_content_desc)
    public void llyMainReleaseBanJiaContentDescOnclick(){
        Intent intent = new Intent(this, MiaoShuActivity.class);
        startActivityForResult(intent,OTHER_DESC);
    }
    @BindView(R.id.bt_main_release_banjia_content_submit)
    Button btMainReleaseBanJiaContentSubmit;
    @OnClick(R.id.bt_main_release_banjia_content_submit)
    public void btMainReleaseBanJiaContentSubmitOnclick(){
        submitReleaseDataToNet();
    }


    @BindView(R.id.tv_main_release_banjia_content_leibie)
    TextView tvMainReleaseBanJiaContentLeiBie;
    @BindView(R.id.lly_main_release_banjia_content_leibie)
    LinearLayout llyMainReleaseBanJiaContentLeiBie;
    @OnClick(R.id.lly_main_release_banjia_content_leibie)
    public void llyMainReleaseBanJiaContentLeiBieOnclick(){
        Intent intent = new Intent(this, CarTypeActivity.class);
        startActivityForResult(intent,LEIBIE);
    }


    private ReleaseBanJiaController releaseBanJiaController;
    @Override
    protected void setContentView() {
        setContentView(R.layout.activity_main_release_banjia_lly);
    }
    ...
    private void initController(){
        releaseBanJiaController = new ReleaseBanJiaController(this);
    }
    ...
    private void submitReleaseDataToNet(){
        ...
        mainReleaseNetWork.releaseCarSourceToNet(getParam(), new Observer<CarSourceBean>() {
            ...
            public void onNext(CarSourceBean carSourceBean) {
                Toast.makeText(ReleaseBanJiaActivity.this,""+carSourceBean.getMsg().toString(),Toast.LENGTH_LONG).show();
            }
        });
    ...
    /*    initImgs();*/
        ...
        String type = "2";
        String type_name = tvMainReleaseBanJiaContentCarType.getText().toString().trim();
        if(type_name == null){
            type_name ="";
        }
        String address_set = tvMainReleaseBanJiaContentBegin.getText().toString().trim();
        /*String set_aid = "1";*/
        if((address_set == null)||(address_set.isEmpty())){
            Toast.makeText(this,"请输入出发地",Toast.LENGTH_LONG).show();
            return paramMap;
        }
        String address_out = tvMainReleaseBanJiaContentReach.getText().toString().trim();
        /*String set_cid = "2";*/
        if((address_out == null)||(address_out.isEmpty())){
            Toast.makeText(this,"请输入到达地",Toast.LENGTH_LONG).show();
            return paramMap;
        }
        String car_title = etMainReleaseBanJiaContentTel.getText().toString().trim();
        /*String car_title = "4";*/
        if(car_title == null){
            Toast.makeText(this,"请输入标题",Toast.LENGTH_LONG).show();
            car_title ="";
        }
        String car_type = tvMainReleaseBanJiaContentCarType.getText().toString().trim();
        /*String car_type = "5";*/
        if(car_type == null){
            car_type ="";
        }
        String car_lange = tvMainReleaseBanJiaContentCarLength.getText().toString().trim();
        /*String car_lange ="1";*/
        if(car_lange == null){
            car_lange ="";
        }

        String iphone = etMainReleaseBanJiaContentTel.getText().toString().trim();
        /*String iphone = "3";*/
        ...
        String people = etMainReleaseBanJiaContentLXR.getText().toString().trim();
        /*String people = "3";*/
        ...
        String address = etMainReleaseBanJiaContentAddr.getText().toString().trim();
        /*String address = "3";*/
       /* if((address == null)||(address.isEmpty())){
        ...
        String content = tvMainReleaseBanJiaContentDesc.getText().toString().trim();
    ...
    public void initImgs(){
        ...
        if (file.exists()) {
            ...
            //将图片显示到ImageView中
            ibMainReleaseBanJiaPicPick.setImageBitmap(bm);
...
/*        Toast.makeText(BanJiaReleaseActivity.this,"requestCode:"+requestCode,Toast.LENGTH_LONG).show();
        Toast.makeText(BanJiaReleaseActivity.this,"resultCode:"+resultCode,Toast.LENGTH_LONG).show();
        Toast.makeText(BanJiaReleaseActivity.this,"data:"+resultCode,Toast.LENGTH_LONG).show();*/
        ...
        switch (resultCode) {
            case ACTIVITY_REQUEST_SELECT_PHOTO:
               ...
               /* Log.i("mImageListSize",mImageList.get(0)+"");
                ...
                if(mImageList.size()>0) {
                    ...
                    tvMainReleaseBanJiaSelectedNum.setText("已选择"+mImageList.size()+"张照片");

                    Log.i("\nthis is mImageList:",""+mImageList.size());

                }else{
                    tvMainReleaseBanJiaSelectedNum.setText("");

                    ibMainReleaseBanJiaPicPick.setImageResource(R.mipmap.paizhao);
                }
            ...
            case CITY_CHANGE_SELECTED:
              ...
              /*  Toast.makeText(BanJiaReleaseActivity.this,"city:"+city,Toast.LENGTH_LONG).show();*/
                if(city != null){
                    if(isBegin) {
                        aid = id1;
                        cid = id2;
                        tid = id3;
                        tvMainReleaseBanJiaContentBegin.setText(city);
                    }else {
                        aid1 = id1;
                        cid1 = id2;
                        tid1 = id3;
                        tvMainReleaseBanJiaContentReach.setText(city);
                    }
                }
            ...
            case OTHER_DESC:
                ...
                if(desc != null){
                    tvMainReleaseBanJiaContentDesc.setText(desc);
                }
                break;
            case LEIBIE:
                Bundle bundle1 = data.getExtras();
                String leibie = bundle1.getString("leibie");
                if(leibie!= null){
                    tvMainReleaseBanJiaContentLeiBie.setText(leibie);
                }
                break;
