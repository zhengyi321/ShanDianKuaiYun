...
public class GoodsTypeRVAdapter extends RecyclerView.Adapter<GoodsTypeRVAdapter.ItemViewHolder>  {
    ...
    public GoodsTypeRVAdapter(Activity activity1, String[] stringList1 ){
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ItemViewHolder(inflater.inflate(R.layout.activity_main_release_fabuhuowu_huowuleibie_content_rv_item_lly,parent,false));
    }
    ...
    public class ItemViewHolder extends RecyclerView.ViewHolder{
        ...
        @BindView(R.id.tv_main_release_fabuhuowu_huowuleibie_content_rv_item)
        TextView tvMainReleaseBanJiaLeiBieContentRVItem;
        @BindView(R.id.rly_main_release_fabuhuowu_huowuleibie_content_rv_item)
        RelativeLayout rlyMainReleaseBanJiaLeiBieContentRVItem;
        @OnClick(R.id.rly_main_release_fabuhuowu_huowuleibie_content_rv_item)
        public void rlyMainReleaseBanJiaLeiBieContentRVItemOnclick(){
            ...
            bundle.putString("huowuleibie",leibie);
