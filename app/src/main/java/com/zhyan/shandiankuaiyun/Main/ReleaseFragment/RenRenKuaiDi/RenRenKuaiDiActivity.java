package com.zhyan.shandiankuaiyun.Main.ReleaseFragment.RenRenKuaiDi;
...
import com.zhyan.shandiankuaiyun.Main.ReleaseFragment.ZhuanXianWuLiu.MiaoShu.MiaoShuActivity;
import com.zhyan.shandiankuaiyun.Main.ReleaseFragment.ZhuanXianWuLiu.SelectPicActivity;
import com.zhyan.shandiankuaiyun.Main.ReleaseFragment.ZhuanXianWuLiu.ZhuanXianWuLiuReleaseActivity;
import com.zhyan.shandiankuaiyun.NetWork.MainReleaseNetWork;
...
public class RenRenKuaiDiActivity extends BaseActivity {
    ...
    @BindView(R.id.tv_main_release_renrenkuaidi_selected_num)
    TextView tvMainReleaseRenRenKuaiDiSelectedNum;

    @BindView(R.id.ib_main_release_renrenkuaidi_pic_pick)
    ImageButton ibMainReleaseRenRenKuaiDiPicPick;
    @OnClick(R.id.ib_main_release_renrenkuaidi_pic_pick)
    public void ibMainReleaseRenRenKuaiDiPicPickOnclick(){
    ...
    @BindView(R.id.tv_main_release_renrenkuaidi_content_begin)
    TextView tvMainReleaseRenRenKuaiDiContentBegin;
    @BindView(R.id.lly_main_release_renrenkuaidi_content_begin)
    LinearLayout llyMainReleaseRenRenKuaiDiContentBegin;
    @OnClick(R.id.lly_main_release_renrenkuaidi_content_begin)
    public void llyMainReleaseRenRenKuaiDiContentBeginOnclick(){
        isBegin = true;
        Intent intent = new Intent(RenRenKuaiDiActivity.this, CityChangeActivity.class);
        startActivityForResult(intent,CITY_CHANGE_SELECTED);
    }
    @BindView(R.id.tv_main_release_renrenkuaidi_content_reach)
    TextView tvMainReleaseRenRenKuaiDiContentReach;
    @BindView(R.id.lly_main_release_renrenkuaidi_content_reach)
    LinearLayout llyMainReleaseRenRenKuaiDiContentReach;
    @OnClick(R.id.lly_main_release_renrenkuaidi_content_reach)
    public void llyMainReleaseRenRenKuaiDiContentReachOnclick(){
        isBegin = false;
        Intent intent = new Intent(RenRenKuaiDiActivity.this, CityChangeActivity.class);
        startActivityForResult(intent,CITY_CHANGE_SELECTED);
    }

    @BindView(R.id.et_main_release_renrenkuaidi_content_title)
    EditText etMainReleaseRenRenKuaiDiContentTitle;
    ...
    @BindView(R.id.et_main_release_renrenkuaidi_content_tel)
    EditText etMainReleaseRenRenKuaiDiContentTel;
    @BindView(R.id.et_main_release_renrenkuaidi_content_lxr)
    EditText etMainReleaseRenRenKuaiDiContentLXR;
    @BindView(R.id.et_main_release_renrenkuaidi_content_addr)
    EditText etMainReleaseRenRenKuaiDiContentAddr;
    @BindView(R.id.tv_main_release_renrenkuaidi_content_desc)
    TextView tvMainReleaseRenRenKuaiDiContentDesc;
    @BindView(R.id.lly_main_release_renrenkuaidi_content_desc)
    LinearLayout llyMainReleaseRenRenKuaiDiContentDesc;
    @OnClick(R.id.lly_main_release_renrenkuaidi_content_desc)
    public void llyMainReleaseRenRenKuaiDiContentDescOnclick(){
        Intent intent = new Intent(this, MiaoShuActivity.class);
        startActivityForResult(intent,OTHER_DESC);
    }
    @BindView(R.id.bt_main_release_renrenkuaidi_content_submit)
    Button btMainReleaseRenRenKuaiDiContentSubmit;
    @OnClick(R.id.bt_main_release_renrenkuaidi_content_submit)
    public void btMainReleaseRenRenKuaiDiContentSubmitOnclick(){
        submitReleaseDataToNet();
    }


    private RenRenKuaiDiController renRenKuaiDiController;
    @Override
    protected void setContentView() {
        setContentView(R.layout.activity_main_release_renrenkuaidi_lly);
    }
    ...
    private void initController(){
        renRenKuaiDiController = new RenRenKuaiDiController(this);
    }
    private void submitReleaseDataToNet(){
        MainReleaseNetWork mainReleaseNetWork = new MainReleaseNetWork();
/*        mainReleaseNetWork.releaseRenRenKuaiDiToNet(paramMap,base64_00,base64_01,base64_02,base64_03,base64_04,base64_05,base64_06,base64_07, new Observer<CarSourceBean>() {
        mainReleaseNetWork.releaseRenRenKuaiDiToNet(paramMap,no18,no19,no20,no21,no22,no23,no24,no25, new Observer<CarSourceBean>() {*/
        mainReleaseNetWork.releaseCarSourceToNet(getParam(), new Observer<CarSourceBean>() {
            ...
            public void onError(Throwable e) {
                /*Toast.makeText(RenRenKuaiDiReleaseActivity.this,"this is Throwable:"+e,Toast.LENGTH_LONG).show();*/
                System.out.print("\nthis is Throwable:"+e);
                System.out.print("\nthis is Throwable:"+e);
                System.out.print("\nthis is Throwable:"+e);
                System.out.print("\nthis is Throwable:"+e);
            ...
            public void onNext(CarSourceBean carSourceBean) {
                Toast.makeText(RenRenKuaiDiActivity.this,""+carSourceBean.getMsg().toString(),Toast.LENGTH_LONG).show();
            }
        });
    ...
    /*    initImgs();*/
        ...
        String address_set = tvMainReleaseRenRenKuaiDiContentBegin.getText().toString().trim();
        /*String set_aid = "1";*/
        if((address_set == null)||(address_set.isEmpty())){
            Toast.makeText(this,"请输入出发地",Toast.LENGTH_LONG).show();
            return paramMap;
        }
        String address_out = tvMainReleaseRenRenKuaiDiContentReach.getText().toString().trim();
        /*String set_cid = "2";*/
        if((address_out == null)||(address_out.isEmpty())){
            Toast.makeText(this,"请输入到达地",Toast.LENGTH_LONG).show();
            return paramMap;
        }
        String car_title = etMainReleaseRenRenKuaiDiContentTel.getText().toString().trim();
        /*String car_title = "4";*/
        if(car_title == null){
            Toast.makeText(this,"请输入标题",Toast.LENGTH_LONG).show();
            car_title ="";
        }
        String car_type = tvMainReleaseRenRenKuaiDiContentCarType.getText().toString().trim();
        /*String car_type = "5";*/
        if(car_type == null){
            car_type ="";
        }
        String car_lange = tvMainReleaseRenRenKuaiDiContentCarLength.getText().toString().trim();
        /*String car_lange ="1";*/
        if(car_lange == null){
            car_lange ="";
        }

        String iphone = etMainReleaseRenRenKuaiDiContentTel.getText().toString().trim();
        /*String iphone = "3";*/
        ...
        String people = etMainReleaseRenRenKuaiDiContentLXR.getText().toString().trim();
        /*String people = "3";*/
        ...
        String address = etMainReleaseRenRenKuaiDiContentAddr.getText().toString().trim();
        /*String address = "3";*/
       /* if((address == null)||(address.isEmpty())){
        ...
        String content = tvMainReleaseRenRenKuaiDiContentDesc.getText().toString().trim();
    ...
    public void initImgs(){
        ...
        if (file.exists()) {
            ...
            //将图片显示到ImageView中
            ibMainReleaseRenRenKuaiDiPicPick.setImageBitmap(bm);
...
/*        Toast.makeText(RenRenKuaiDiReleaseActivity.this,"requestCode:"+requestCode,Toast.LENGTH_LONG).show();
        Toast.makeText(RenRenKuaiDiReleaseActivity.this,"resultCode:"+resultCode,Toast.LENGTH_LONG).show();
        Toast.makeText(RenRenKuaiDiReleaseActivity.this,"data:"+resultCode,Toast.LENGTH_LONG).show();*/
        ...
        switch (resultCode) {
            case ACTIVITY_REQUEST_SELECT_PHOTO:
               ...
               /* Log.i("mImageListSize",mImageList.get(0)+"");
                ...
                if(mImageList.size()>0) {
                    ...
                    tvMainReleaseRenRenKuaiDiSelectedNum.setText("已选择"+mImageList.size()+"张照片");

                    Log.i("\nthis is mImageList:",""+mImageList.size());

                }else{
                    tvMainReleaseRenRenKuaiDiSelectedNum.setText("");

                    ibMainReleaseRenRenKuaiDiPicPick.setImageResource(R.mipmap.paizhao);
                }
            ...
            case CITY_CHANGE_SELECTED:
              ...
              /*  Toast.makeText(RenRenKuaiDiReleaseActivity.this,"city:"+city,Toast.LENGTH_LONG).show();*/
                if(city != null){
                    if(isBegin) {
                        aid = id1;
                        cid = id2;
                        tid = id3;
                        tvMainReleaseRenRenKuaiDiContentBegin.setText(city);
                    }else {
                        aid1 = id1;
                        cid1 = id2;
                        tid1 = id3;
                        tvMainReleaseRenRenKuaiDiContentReach.setText(city);
                    }
                }
            ...
            case OTHER_DESC:
                ...
                if(desc != null){
                    tvMainReleaseRenRenKuaiDiContentDesc.setText(desc);
                }
                break;
