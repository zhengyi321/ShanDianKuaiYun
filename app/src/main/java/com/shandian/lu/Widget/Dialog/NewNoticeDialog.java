...
public class NewNoticeDialog extends Dialog {
    ...
    public NewNoticeDialog(Context context1,String type1 ) {
        super(context1);
        this.context = context1;
        types = type1;

    }
    public NewNoticeDialog(Context context1, int themeResId) {
        super(context1, themeResId);
        this.context = context1;
    }

    protected NewNoticeDialog(Context context1, boolean cancelable, OnCancelListener cancelListener) {
    ...
    public  class Builder {
         ...
         * 4，显示dialog的布局
         */
        public NewNoticeDialog build(Context context) {
            LayoutInflater mInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            NewNoticeDialog releaseDialog = new NewNoticeDialog(context, R.style.MyDialogStyle);//默认调用带style的构造
            releaseDialog.setCanceledOnTouchOutside(true);//默认点击布局外不能取消dialog
           /* releaseDialog.setCancelable(true);*/
            View view = mInflater.inflate(R.layout.dialog_new_orders_rly, null);
