...
public class NewHuoYuanDetaiOtherBaoJiaWaitController extends BaseController {
    ...
    public NewHuoYuanDetaiOtherBaoJiaWaitController(Activity activity1){
        activity = activity1;
        init();
    }
    ...
    public void initDetail(NewBaoJiaSelectBean newHuoYuanDetailBean){
