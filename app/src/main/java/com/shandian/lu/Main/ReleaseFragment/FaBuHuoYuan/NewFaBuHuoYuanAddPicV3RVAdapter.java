...
public class NewFaBuHuoYuanAddPicV3RVAdapter extends RecyclerView.Adapter<NewFaBuHuoYuanAddPicV3RVAdapter.MyItemViewHolder> {
...
/*
    ...
    public NewFaBuHuoYuanAddPicV3RVAdapter(Activity activity1, ArrayList<String> mImageList1){
        activity = activity1;
        ...
        if(isUpdate){
           ...
           /* Toast.makeText(activity,"netSize:"+netSize,3000).show();
            ...
            if(position < netSize){
                ...
                ImageLoader.getInstance().displayImage(pic,holder.rcivNewMainReleaseFaBuHuoYuanAdd,ImageLoaderUtils.options1);
            ...
            if(indexOfWWW >= 0){
               ...
               /* Toast.makeText(activity,"sec"+pic,3000).show();*/
                ...
                sendPicToNet(bitmap,holder.pbNewFaBuHuoYuanPicItem,holder.rcivNewMainReleaseFaBuHuoYuanAdd,pic,holder.ivNewMainReleaseFaBuHuoYuanDelete);
            }
...
/*        System.out.print("\nbase64:"+base64_00);*/
    ...
    private Map<String,String> getParamMap(Bitmap bm){
        ...
        XCCacheManager xcCaHuoManager = XCCacheManager.getInstance(activity);
        String loginId= xcCaHuoManager.readCache(xcCacheSaveName.logId);
