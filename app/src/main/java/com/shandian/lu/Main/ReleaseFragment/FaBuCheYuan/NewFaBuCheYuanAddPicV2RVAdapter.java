...
public class NewFaBuCheYuanAddPicV2RVAdapter extends RecyclerView.Adapter<NewFaBuCheYuanAddPicV2RVAdapter.MyItemViewHolder> {
    ...
    public NewFaBuCheYuanAddPicV2RVAdapter(Activity activity1, List<String> tempList1, ProgressBar progressBar1){
        activity = activity1;
        tempList = tempList1;
            ...
            if(isUpdate) {
                ...
                if(position < bitSize){
                    ...
                    if (indexOf <= 0) {
                        ...
                        ImageLoader.getInstance().displayImage(tempList.get(position), holder.rcivNewMainReleaseFaBuCheYuanAdd, ImageLoaderUtils.options1);
                    }
                ...
                int bitSize = bitmapList.size();
                if(position < bitSize){
                    holder.rcivNewMainReleaseFaBuCheYuanAdd.setImageBitmap(bitmapList.get(position));
                }
