...
package com.zhyan.shandiankuaiyunlib.Widget.ImageView.RoundCornerImageView;
...
public class RoundCornerImageView extends ImageView {
   ...
   * width.
   *
   * @return if this {@link RoundCornerImageView} is set to oval.
   */
   ...
   *
   * @param oval if this {@link RoundCornerImageView} should be oval.
   */
  ...
  /**
   * Set whether the {@link RoundCornerImageView} should round the background drawable according to
