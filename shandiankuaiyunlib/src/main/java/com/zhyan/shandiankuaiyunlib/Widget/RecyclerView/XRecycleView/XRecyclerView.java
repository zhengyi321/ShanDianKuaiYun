package com.zhyan.shandiankuaiyunlib.Widget.RecyclerView.XRecycleView;

import android.content.Context;
import android.graphics.Canvas;
import android.graphics.Rect;
import android.graphics.drawable.Drawable;
import android.support.design.widget.AppBarLayout;//compile 'com.android.support:design:25.1.1'
import android.support.design.widget.CoordinatorLayout;//compile 'com.android.support:design:25.1.1'
import android.support.v7.widget.GridLayoutManager;//compile 'com.android.support:design:25.1.1'
import android.support.v7.widget.LinearLayoutManager;//compile 'com.android.support:design:25.1.1'
import android.support.v7.widget.RecyclerView;//compile 'com.android.support:design:25.1.1'
import android.support.v7.widget.StaggeredGridLayoutManager;//compile 'com.android.support:design:25.1.1'
