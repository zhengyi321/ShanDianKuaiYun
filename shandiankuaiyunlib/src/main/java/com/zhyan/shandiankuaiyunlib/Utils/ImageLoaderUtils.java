...
public class ImageLoaderUtils {
    ...
    static {
        options = new DisplayImageOptions.Builder()
                .showImageOnLoading(R.mipmap.splash) // 设置图片下载期间显示的图�?
                .showImageForEmptyUri(R.mipmap.splash) // 设置图片Uri为空或是错误的时候显示的图片
                .showImageOnFail(R.mipmap.splash) // 设置图片加载或解码过程中发生错误显示的图�?
