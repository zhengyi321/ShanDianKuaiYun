...
import zhyan.likeiosselectpopuplib.adapter.NumericWheelAdapter;
...
public class ProCityAreaWheelTime {
    public static DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    private View view;
    private ProCityAreaWheelView wv_year;
    private ProCityAreaWheelView wv_month;
    private ProCityAreaWheelView wv_day;
    private ProCityAreaWheelView wv_hours;
    private ProCityAreaWheelView wv_mins;
    private ProCityAreaWheelView wv_seconds;
    private int gravity;
    ...
    public ProCityAreaWheelTime(View view) {
        super();
        this.view = view;
    ...
    public ProCityAreaWheelTime(View view, boolean[] type, int gravity, int textSize) {
        super();
        this.view = view;
        this.type = type;
    ...
    public void setPicker(int year, final int month, int day, int h, int m, int s) {
      ...
      /*  final Context context = view.getContext();*/
        currentYear = year;
        // 年
        wv_year = (ProCityAreaWheelView) view.findViewById(R.id.year);
        wv_year.setAdapter(new NumericWheelAdapter(startYear, endYear));// 设置"年"的显示数据
        /*wv_year.setLabel(context.getString(R.string.pickerview_year));// 添加文字*/
        wv_year.setCurrentItem(year - startYear);// 初始化时显示的数据
        wv_year.setGravity(gravity);
        // 月
        wv_month = (ProCityAreaWheelView) view.findViewById(R.id.month);
     ...
     /*   wv_month.setLabel(context.getString(R.string.pickerview_month));*/
        ...
        // 日
        wv_day = (ProCityAreaWheelView) view.findViewById(R.id.day);
       ...
       /* wv_day.setLabel(context.getString(R.string.pickerview_day));*/
        ...
        //时
        wv_hours = (ProCityAreaWheelView) view.findViewById(R.id.hour);
        wv_hours.setAdapter(new NumericWheelAdapter(0, 23));
      /*  wv_hours.setLabel(context.getString(R.string.pickerview_hours));// 添加文字*/
        wv_hours.setCurrentItem(h);
        wv_hours.setGravity(gravity);
        //分
        wv_mins = (ProCityAreaWheelView) view.findViewById(R.id.min);
        wv_mins.setAdapter(new NumericWheelAdapter(0, 59));
       /* wv_mins.setLabel(context.getString(R.string.pickerview_minutes));// 添加文字*/
        wv_mins.setCurrentItem(m);
        wv_mins.setGravity(gravity);
        //秒
        wv_seconds = (ProCityAreaWheelView) view.findViewById(R.id.second);
