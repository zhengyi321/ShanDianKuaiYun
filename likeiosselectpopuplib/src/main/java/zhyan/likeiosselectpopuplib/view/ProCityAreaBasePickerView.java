...
import zhyan.likeiosselectpopuplib.listener.OnDismissListener;
import zhyan.likeiosselectpopuplib.utils.PickerViewAnimateUtil;

/**
 * Created by Sai on 15/11/22.
 * 精仿iOSPickerViewController控件
 */
public class ProCityAreaBasePickerView {
    ...
    public ProCityAreaBasePickerView(Context context) {
        ...
        decorView.post(new Runnable() {
            ...
            public void run() {
                ...
                if (onDismissListener != null) {
                    onDismissListener.onDismiss(ProCityAreaBasePickerView.this);
                }
            }
        });
    ...
    public ProCityAreaBasePickerView setOnDismissListener(OnDismissListener onDismissListener) {
    ...
    protected ProCityAreaBasePickerView setOutSideCancelable(boolean isCancelable) {
        if (rootView != null) {
