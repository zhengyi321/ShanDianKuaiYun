package zhyan.likeiosselectpopuplib.view;
...
import zhyan.likeiosselectpopuplib.R;
import zhyan.likeiosselectpopuplib.adapter.ProCityAreaArrayWheelAdapter;
import zhyan.likeiosselectpopuplib.lib.ProCityAreaWheelView;
import zhyan.likeiosselectpopuplib.listener.OnItemSelectedListener;

public class ProCityAreaWheelOptions<T> {
    private View view;
    private ProCityAreaWheelView wv_option1;
    private ProCityAreaWheelView wv_option2;
    private ProCityAreaWheelView wv_option3;
    ...
    private ProCityAreaWheelView.DividerType dividerType;
    ...
    public ProCityAreaWheelOptions(View view, Boolean linkage) {
        super();
        this.linkage = linkage;
        this.view = view;
        wv_option1 = (ProCityAreaWheelView) view.findViewById(R.id.options1);// 初始化时显示的数据
        wv_option2 = (ProCityAreaWheelView) view.findViewById(R.id.options2);
        wv_option3 = (ProCityAreaWheelView) view.findViewById(R.id.options3);
    }
    ...
    public void setPicker(List<T> options1Items,
        ...
        int len = ProCityAreaArrayWheelAdapter.DEFAULT_LENGTH;
        if (this.mOptions3Items == null)
            len = 8;
        if (this.mOptions2Items == null)
            len = 12;
        // 选项1
        wv_option1.setAdapter(new ProCityAreaArrayWheelAdapter(mOptions1Items, len));// 设置显示数据
        wv_option1.setCurrentItem(0);// 初始化时显示的数据
        // 选项2
        if (mOptions2Items != null)
            wv_option2.setAdapter(new ProCityAreaArrayWheelAdapter(mOptions2Items.get(0)));// 设置显示数据
        wv_option2.setCurrentItem(wv_option1.getCurrentItem());// 初始化时显示的数据
        // 选项3
        if (mOptions3Items != null)
            wv_option3.setAdapter(new ProCityAreaArrayWheelAdapter(mOptions3Items.get(0).get(0)));// 设置显示数据
        ...
        wheelListener_option1 = new OnItemSelectedListener() {
            ...
            public void onItemSelected(int index) {
                ...
                if (mOptions2Items != null) {
                    ...
                    wv_option2.setAdapter(new ProCityAreaArrayWheelAdapter(mOptions2Items.get(index)));
        ...
        wheelListener_option2 = new OnItemSelectedListener() {
            ...
            public void onItemSelected(int index) {
                if (mOptions3Items != null) {
                    ...
                    wv_option3.setAdapter(new ProCityAreaArrayWheelAdapter(mOptions3Items
    ...
    public void setNPicker(List<T> options1Items,
        ...
        if (N_mOptions2Items != null)
            wv_option2.setAdapter(new ProCityAreaArrayWheelAdapter(N_mOptions2Items));// 设置显示数据
        wv_option2.setCurrentItem(wv_option1.getCurrentItem());// 初始化时显示的数据
        // 选项3
        if (N_mOptions3Items != null)
            wv_option3.setAdapter(new ProCityAreaArrayWheelAdapter(N_mOptions3Items));// 设置显示数据
        wv_option3.setCurrentItem(wv_option3.getCurrentItem());
        wv_option1.setIsOptions(true);
        wv_option2.setIsOptions(true);
        wv_option3.setIsOptions(true);
    ...
    private void itemSelected(int opt1Select, int opt2Select, int opt3Select) {
        if (mOptions2Items != null) {
            wv_option2.setAdapter(new ProCityAreaArrayWheelAdapter(mOptions2Items
                    .get(opt1Select)));
            wv_option2.setCurrentItem(opt2Select);
        }
        if (mOptions3Items != null) {
     ...
     * @param dividerType
     */
    public void setDividerType(ProCityAreaWheelView.DividerType dividerType) {
