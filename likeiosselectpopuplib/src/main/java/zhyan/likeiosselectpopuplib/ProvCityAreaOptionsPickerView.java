package zhyan.likeiosselectpopuplib;
...
import zhyan.likeiosselectpopuplib.view.ProCityAreaWheelOptions;

/**
 * 条件选择器
 * Created by Sai on 15/11/22.
 */
public class ProvCityAreaOptionsPickerView<T> extends ProCityAreaBasePickerView implements View.OnClickListener {

    ProCityAreaWheelOptions<T> wheelOptions;
    ...
    private int option2;
    private int option3;
    private ProCityAreaWheelView.DividerType dividerType;//分隔线类型

    //构造方法
    public ProvCityAreaOptionsPickerView(Builder builder) {
    ...
    public static class Builder {
         ...
         * @param dividerType
         */
        public Builder setDividerType(ProCityAreaWheelView.DividerType dividerType) {
        ...
        public ProvCityAreaOptionsPickerView build() {
            return new ProvCityAreaOptionsPickerView(this);
        }
    }
    ...
    private void initView(Context context) {
        ...
        wheelOptions = new ProCityAreaWheelOptions(optionsPicker, linkage);
